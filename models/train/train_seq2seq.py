...
def make_parser():
    ...
    parser.add_argument('--hierarchical_h_translation', choices=[None, 'linear', 'mlp'], default=None)
    parser.add_argument('--hierarchical_c_translation', choices=[None, 'linear', 'mlp'], default=None)
